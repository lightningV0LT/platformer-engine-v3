...
function preload() {
  AssetLoader.block_sprites = loadImage('engine-ver3.1/assets/block-sprites.png');
  Game.level_data = loadJSON('engine-ver3.1/data/level-data.JSON');
  Game.block_data = loadJSON('engine-ver3.1/data/block-data.JSON');
  Player.stats = loadJSON('engine-ver3.1/data/player-stats.JSON');
}
