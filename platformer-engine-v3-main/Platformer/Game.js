...
export default class Game {
  ...
  loadNew(newLvl) {
    ...
    for (const block of this.objects) {
      if (!block.onLoad || typeof block.onLoad !== 'object') continue;
      Object.keys(block.onLoad).forEach(k => behaviors?.onLoad[k]?.({block, game: this, factor: block.onLoad[k]}));
    }
